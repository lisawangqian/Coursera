...
%{
  ...
  for the location of tokens */
    ...
    */
    ...
    %type <expressions> expression_comma_list_wrap
    %type <expressions> expression_semi_list
    ...
    */
    ...
    { $$ = assign($1, $3); }
    | expression '.' OBJECTID '(' expression_comma_list_wrap ')'
    { $$ = dispatch($1, $3, $5);  }
    | expression '@' TYPEID '.' OBJECTID '(' expression_comma_list_wrap ')'
    { $$ = static_dispatch($1, $3, $5, $7);  }
    | OBJECTID '(' expression_comma_list_wrap ')' /* implicit self */
